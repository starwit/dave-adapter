...
@JsonPropertyOrder({
  ...
  MessquerschnittDto.JSON_PROPERTY_LONGITUDE,
  MessquerschnittDto.JSON_PROPERTY_LATITUDE
})
...
public class MessquerschnittDto {
  ...
  public MessquerschnittDto mqId(@jakarta.annotation.Nullable String mqId) {
  ...
  @JsonProperty(JSON_PROPERTY_MQ_ID)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setMqId(@jakarta.annotation.Nullable String mqId) {
    this.mqId = mqId;
  }

  public MessquerschnittDto mstId(@jakarta.annotation.Nullable String mstId) {
  ...
  public MessquerschnittDto strassenname(@jakarta.annotation.Nullable String strassenname) {
  ...
  @JsonProperty(JSON_PROPERTY_STRASSENNAME)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setStrassenname(@jakarta.annotation.Nullable String strassenname) {
    this.strassenname = strassenname;
  }

  public MessquerschnittDto lageMessquerschnitt(@jakarta.annotation.Nullable String lageMessquerschnitt) {
  ...
  @JsonProperty(JSON_PROPERTY_LAGE_MESSQUERSCHNITT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setLageMessquerschnitt(@jakarta.annotation.Nullable String lageMessquerschnitt) {
    this.lageMessquerschnitt = lageMessquerschnitt;
  }

  public MessquerschnittDto fahrtrichtung(@jakarta.annotation.Nullable String fahrtrichtung) {
  ...
  @JsonProperty(JSON_PROPERTY_FAHRTRICHTUNG)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setFahrtrichtung(@jakarta.annotation.Nullable String fahrtrichtung) {
    this.fahrtrichtung = fahrtrichtung;
  }

  public MessquerschnittDto anzahlFahrspuren(@jakarta.annotation.Nullable Integer anzahlFahrspuren) {
  ...
  @JsonProperty(JSON_PROPERTY_ANZAHL_FAHRSPUREN)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAnzahlFahrspuren(@jakarta.annotation.Nullable Integer anzahlFahrspuren) {
    this.anzahlFahrspuren = anzahlFahrspuren;
  }

  public MessquerschnittDto anzahlDetektoren(@jakarta.annotation.Nullable Integer anzahlDetektoren) {
  ...
  @JsonProperty(JSON_PROPERTY_ANZAHL_DETEKTOREN)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAnzahlDetektoren(@jakarta.annotation.Nullable Integer anzahlDetektoren) {
    this.anzahlDetektoren = anzahlDetektoren;
  }

  public MessquerschnittDto longitude(@jakarta.annotation.Nullable Double longitude) {
  ...
  public MessquerschnittDto latitude(@jakarta.annotation.Nullable Double latitude) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.mqId, messquerschnittDto.mqId) &&
        ...
        Objects.equals(this.longitude, messquerschnittDto.longitude) &&
        Objects.equals(this.latitude, messquerschnittDto.latitude);
  }

  @Override
  public int hashCode() {
    return Objects.hash(mqId, mstId, strassenname, lageMessquerschnitt, fahrtrichtung, anzahlFahrspuren, anzahlDetektoren, longitude, latitude);
  }
